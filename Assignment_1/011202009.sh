...
do
    ...
    #     do
    #         # echo $line
    #         export INDEX_GRADE=0
    #         export INDEX_MARKS=0
    #         export GRADE_MAIN=1        # which line no. of original grade
    #         export GRADE_STUDENT=1     # while line no. of student grade
    #         for (( i=0; i<${#arr[@]}; i=i+2 ))
    #         do
    #             if [ ${arr_marks[$INDEX_MARKS]} >= ${arr[$i]} ] && [ ${arr_marks[$INDEX_MARKS]} <= ${arr[$((i+1))]} ]; then
